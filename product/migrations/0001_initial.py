# Generated by Django 5.0.3 on 2024-03-18 19:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('point_equivalent', models.IntegerField(default=-1, verbose_name='Эквалент баллами')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_orderitem', to='product.order', verbose_name='Заказ')),
